...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/code-to-prd/scripts/codebase_analyzer.py {project_path} -o .code-to-prd-analysis.json
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/code-to-prd/scripts/prd_scaffolder.py .code-to-prd-analysis.json -o prd/
```
