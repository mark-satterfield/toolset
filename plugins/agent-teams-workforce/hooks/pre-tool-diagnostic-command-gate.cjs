...
function main() {
  ...
  process.stderr.write(
    `${[
      ...
      '  - the integration workflow runs the suites the contract calls for and returns passed',
      '  - flaky-test-detector confirms an intermittent failure by controlled reruns',
      '  - root-cause-analyst reproduces a failure and diagnoses its root cause',
      '',
