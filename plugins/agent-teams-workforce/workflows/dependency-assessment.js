...
4. Check each against the SAD, and drop every decision the SAD already settles. Search the SAD for the decision, and read the section you find. Record, for each decision you keep, which section you consulted and why it leaves the decision open — that record goes on every edge as \`sadCheck\`, and an edge without one is refused. Most architecture decisions the SAD settles need no edge at all: the check is the point of the step, not a formality.
