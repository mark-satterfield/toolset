...
- **Portfolio** — `dependencies-and-scoring.js`: the Epic dependency edges and the WSJF score of every open Epic and Task, recomputed over the whole portfolio, with a model judging only inputs whose source content changed.
