...
- **Inputs Required:** The CDK stacks and synthesized templates from cdk-stack-author (via deployment-lead); target environment identifiers and read access; the rollout result from cdk-stack-author for post-deployment checks; the repo's documented validation commands.
