...
- **Inputs Required:** The spec's acceptance criteria and API contracts; deployed environment endpoints and credentials references from deployment-lead's handoff; the rollout result from cdk-stack-author; the repo's documented test commands and conventions.
