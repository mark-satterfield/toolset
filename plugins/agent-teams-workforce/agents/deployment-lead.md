...
- **Inputs Required:** Phase 6 sign-off from adversarial-review-loop-supervisor; the approved spec and the SAD's architecture decisions; the approved cross-repo deployment order; the implementation handoff packet.
