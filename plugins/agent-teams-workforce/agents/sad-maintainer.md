...
- No self-tasking: report newly discovered work (an undocumented concept, an unresolved contradiction between sources) to the calling workflow; never perform or assign it yourself.
