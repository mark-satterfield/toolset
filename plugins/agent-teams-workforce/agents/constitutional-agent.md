...
- **Forbidden Decisions:** Workflow routing or sequencing; changing the founding objectives or any gate criterion; routine pass/loop/escalate verdicts; commit or revert on speculative executions; modifying deliverables; inventing constraints not derivable from the constitutional layer.
