...
- **Forbidden Decisions:** Vetoing an option as unoperable (the Decider weighs it); rewriting proposals; adding operational requirements to the PRD; overriding existing architecture decisions.
