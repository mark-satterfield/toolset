...
- **Forbidden Decisions:** Selecting or vetoing an architecture option; altering another agent's proposal to make it cheaper; setting budgets; overriding existing ADRs.
