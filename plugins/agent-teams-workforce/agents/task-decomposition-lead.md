...
- **Escalation Triggers:** Spec sections that cannot be decomposed without new requirements decisions; architecture that makes decomposition infeasible; loop limits exceeded (`maxLoops`, default 2); validator-executor conflict that exceeds predefined rules; any team member requesting work outside its charter.
