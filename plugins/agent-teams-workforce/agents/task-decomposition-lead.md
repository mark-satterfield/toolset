...
- **Inputs Required:** Approved spec from phase 3; architecture artifacts (ADRs, contracts, context maps) from phase 2; confirmation that the upstream gate passed; any structured loop feedback from Gate 4.
