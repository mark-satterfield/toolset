...
- **Inputs Required:** The spec's NFRs and acceptance criteria; the deployed architecture and CDK stack summaries from deployment-lead's handoff; the SAD's architecture decisions; the wave deployment context (which services exist where).
