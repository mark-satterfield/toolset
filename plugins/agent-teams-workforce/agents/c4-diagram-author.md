...
- **Forbidden Decisions:** Depicting any system, container, component, relationship, or boundary absent from the decision record or context map; inventing elements to fill a visual gap; renaming or re-bounding anything away from the decided ubiquitous language; switching away from C4/Mermaid without escalation; overriding the decision record or existing ADRs.
