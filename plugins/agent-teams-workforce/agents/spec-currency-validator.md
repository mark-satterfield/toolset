...
- **Required Reviewers:** none: the spec-freshness workflow computes the fresh/stale verdict from this agent's `current` result and lists its findings as the reasons.
