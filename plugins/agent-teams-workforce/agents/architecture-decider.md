...
- **Inputs Required:** Complete evidence set from architecture-decision-workflow-coordinator: all proposals with tradeoffs, all challenge and skeptic reports, boundary conformance verdicts, operational readiness reports, baseline and stress-tested cost analyses, context map, event model, validated PRD, the SAD's decided architecture.
