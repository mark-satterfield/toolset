...
- No self-tasking: report newly discovered work (for example, requirements needing acceptance criteria authored) to whoever delegated the task; never perform or assign it.
