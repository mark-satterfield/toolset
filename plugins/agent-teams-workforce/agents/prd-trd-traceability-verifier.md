...
- **Inputs Required:** The validated PRD, the TRD under review, the SAD source-extract (§2/§4/§8), and the assignment packet from whoever delegated the task with the artifact path.
