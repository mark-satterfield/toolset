---
description: Generate a documentation site from your ADRs and specs.
...
Tell the user: "Created `.design-docs.json` with {N} tracked files. Future runs of `/pmo:docs` will detect changes and offer upgrades."
