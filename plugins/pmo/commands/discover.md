...
|---|------------|----------|----------|---------|
| 1 | High | {short decision title} | {key evidence: files, deps, config} | `/pmo:adr {description}` |
| 2 | Medium | {short decision title} | {key evidence} | `/pmo:adr {description}` |
...
|---|------------|-----------|----------|---------|
| 1 | High | {subsystem name} | {files/dirs that define it} | `/pmo:spec {capability}` |
| 2 | Medium | {subsystem name} | {files/dirs} | `/pmo:spec {capability}` |
...
- A narrower scope might reveal more specific patterns: `/pmo:discover src/`
