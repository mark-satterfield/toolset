---
name: discover-more
description: Discover implicit architectural decisions and spec-worthy subsystems across the SkillSpoke fleet. Reads docs/plans/functional/ as requirement seeds and uses GraphRAG to find implementation evidence across all 60+ repos. Use when the user says "discover architecture", "what decisions exist in this code", "bootstrap ADRs", or wants to reverse-engineer design artifacts from the fleet.
