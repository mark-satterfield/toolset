...
1. Resolve `$ARGUMENTS` per `${CLAUDE_PLUGIN_ROOT}/references/operating-rules.md` §2 into two parts:
...
3. Load and execute `${CLAUDE_PLUGIN_ROOT}/skills/revise-instructions/SKILL.md`.
