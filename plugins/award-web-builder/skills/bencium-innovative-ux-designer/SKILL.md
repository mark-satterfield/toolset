...
- **Effects**: Apple design mimicry, liquid/blob backgrounds
- **Overall**: Anything that looks "Claude-generated" or machine-made

**Glass morphism or Liquid Glass** is Ok in very specific circumstances, like a design element on the landing page, or a special feature or character that is uniue to the site.
