...
```d2
client_requests -> api_gateway
api_gateway -> route_decision: Route Decision {shape: diamond}
route_decision -> legacy_service: Legacy Path
route_decision -> new_service: New Path
legacy_service -> legacy_database
new_service -> new_database
```
