...
4. Apply the pipeline: confirm rendering context, identify the Page context (`libraries/pages/`), load the catalog set for the category, surface the structured markdown response with named sections (Class names / Token names / Event hooks / ARIA contracts / Reference pointers / Halt conditions).
