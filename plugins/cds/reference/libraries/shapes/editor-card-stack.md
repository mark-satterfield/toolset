...
Suits prompt builders, message-flow composers, conversation scripters, and script editors. Pairs with Shell A2 (the right info panel hosts the welcome/help guide).
