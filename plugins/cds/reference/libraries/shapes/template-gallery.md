...
A vertical stack of template entries filling a canvas pane (typically Shell A5's Examples tab), beneath the canvas tab strip. Each entry is a self-contained advert-plus-demo:
