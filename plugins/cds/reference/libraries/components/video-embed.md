...
- The player requests the host's privacy-preserving delivery endpoint where the host offers one, and requests related-content suggestions and host branding be suppressed, so the frame ends at the video rather than at the host's catalog.
