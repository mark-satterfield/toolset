...
# Form-driven sidebar + canvas/gallery
...
- form-sidebar-canvas vs. rail-main-info-panel: form-sidebar-canvas's sidebar drives the canvas; rail-main-info-panel's info panel is help, not input. Help-and-tips belongs in rail-main-info-panel; configuration-that-renders belongs in form-sidebar-canvas.
