...
The Shape pick branches on `item_count`, `taxonomy_type` (role/discipline tagging), and `has_subitems_per_category` via `rules/shape-selection/use-case-routing.md`.
