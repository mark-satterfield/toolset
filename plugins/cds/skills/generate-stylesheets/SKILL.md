...
7. **Compose `themes.css`** — theme bindings (light, dark, any additional modes the YAML declares) per `foundations/implementation.md`. Selectors and resolution order follow the implementation reference exactly.
